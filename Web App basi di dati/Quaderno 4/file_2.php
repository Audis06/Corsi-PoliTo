...
$conn = @mysqli_connect ( 'localhost', 'root', '', 'QUADERNO4' );
...
/* Query construction */
$query = "SELECT V.CodContenuto, V.Data, V.Valutazione, C.Genere
            FROM VALUTAZIONE V, CONTENUTO_MULTIMEDIALE C
            WHERE CodFisc='$fiscal_code'
            AND V.CodContenuto=C.CodContenuto";
