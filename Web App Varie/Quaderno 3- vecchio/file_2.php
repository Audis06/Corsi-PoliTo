...
/* Query construction */
$query = "SELECT P.Titolo, A.NumeroPuntata, A.Data, A.OraInizio, A.OraFine
            FROM PROGRAMMATV P, APPARIZIONE A
            WHERE A.CodiceFiscaleChef='$fiscal_code'
            AND A.CodProgramma=P.CodProgramma";
