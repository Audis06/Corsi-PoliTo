...
//Iniziazzione dell'inventario
invArray_t invArray_init() {
  invArray_t invArray = calloc(1, sizeof(*invArray));
  return invArray;
}
//Funzione di lettura da file del invemtario
...
//Funzione di stampa dell'invemtario
...
//Funzione di ricerca di un determinato oggetto del inventario
